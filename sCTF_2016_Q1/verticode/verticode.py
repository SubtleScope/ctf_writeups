...
# Could be rewritten as a case statement
def getColor(hexVal):
    pixVal = ""
...
def getFlag(getImg, imgWidth, imgHeight, rgbImg, binArr, flagStringArr):
    ...
    for y in xrange(0, imgHeight, 12):
        # Loop through horizontally over thex values (width)
        # in increments of 12 pixels, start at pixel 84
        # since that is where the black and white blocks
        # start
